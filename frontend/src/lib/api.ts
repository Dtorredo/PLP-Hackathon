...
export const API_CONFIG = {
  // Base URL for API calls - uses environment variable or falls back to deployed backend
  BASE_URL: import.meta.env.VITE_API_URL || "https://plp-hackathon.fly.dev",
...
if (isDevelopment) {
  console.log("API Configuration:", {
    ...
    usingDeployedBackend: API_CONFIG.BASE_URL.includes("fly.dev"),
  });
}
